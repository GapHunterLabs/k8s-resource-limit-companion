package dev.gaphunter.k8sresourcelimitcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.k8sresourcelimitcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.k8sresourcelimitcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "K8s Resource Limit Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33800-k8s-resource-limit-companion/reviews"
